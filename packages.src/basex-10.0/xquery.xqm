...
(:~ 
 ...
 : @error xquery:error an unexpected error occurred.
 :)
declare function xquery:fork-join($functions as function(*)*, $options as map(*)?) as item()* external;
