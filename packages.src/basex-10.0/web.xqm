...
(:~ 
 : Creates a new URL from the specified <code>$href</code> string, query string <code>$parameters</code> and an optional <code>$anchor</code> reference. The keys and values of the map entries will be converted to strings, URL-encoded (see <code><a href="https://docs.basex.org/wiki/Web_Module#web:encode-url">web:encode-url</a></code>), and appended to the URL as query parameters. If a map entry has more than a single item, all of them will be appended as single parameters.
 :
 : @param $href value of type xs:string
 : @param $parameters value of type map(*)
 : @return value of type xs:string
 :)
declare function web:create-url($href as xs:string, $parameters as map(*)) as xs:string external;
...
(:~ 
 ...
 : @return value of type xs:string
 :)
declare function web:create-url($href as xs:string, $parameters as map(*), $anchor as xs:string) as xs:string external;
