...
(:~ 
 : Returns the value of an attribute with the specified <code>$name</code> for the WebSocket with the specified <code>$id</code>. If the attribute is unknown, an empty sequence or the optionally specified <code>$default</code> value will be returned instead.
 :
 : @param $id value of type xs:string
...
(:~ 
 : Assigns the specified <code>$value</code> to the attribute with the specified <code>$name</code> for the WebSocket with the specified <code>$id</code>.
 :
 : @param $id value of type xs:string
 : @param $name value of type xs:string
