...
(:~ 
 : Decodes the specified <code>$key</code> (with the optional <code>$lax</code> conversion method) to the original string representation.<br/>Keys supplied to this function can be element names that have been created by the <a href="https://docs.basex.org/wiki/JSON_Module">JSON Module</a> or <a href="https://docs.basex.org/wiki/CSV_Module">CSV Module</a>.
 :
 : @param $key value of type xs:string
 : @return value of type xs:string
