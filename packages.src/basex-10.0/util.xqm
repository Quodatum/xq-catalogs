(:~ 
 : This <a href="https://docs.basex.org/wiki/Module_Library">XQuery Module</a> contains various utility and helper functions.
 :
 : @author BaseX team (wiki scrape by quodatum/xq-catalogs) 
 : @see https://docs.basex.org/wiki/Utility_Module
 :)
...
(:~ 
 ...
 : @param $input value of type item()*
 : @param $count value of type xs:integer
 : @param $repeat value of type xs:boolean?
 : @return value of type item()*
 : @error util:negative The specified number is negative.
 :)
declare function util:replicate($input as item()*, $count as xs:integer, $repeat as xs:boolean?) as item()* external;
...
(:~ 
 : Returns duplicate values in a <code>$sequence</code>. See <a href="https://www.w3.org/TR/xpath-functions-31/#func-distinct-values">fn:distinct-values</a> for the applied equality rules and the usage of the <code>$collation</code> argument.
 :
 : @param $sequence value of type item()*
